  ...
  if (IsUser == "true") {
    ...
    return (
      <>
        ...
        {PolicModal ? (
          <div className="PolicModal px-4 py-7 gap-4 flex flex-col justify-between">
            {/* <div
              onClick={() => {
                setPolicModal(false);
              }}
              ...
              <div className="max-h-[80%] overflow-hidden overflow-y-scroll">
                <div className="">
                  ...
                  <p className="mb-4">
                    ...
                    персональных данных, предпринимаемые Обществом с
                    ограниченной ответственностью “ЛОЯЛ ГИФТ” (далее –
                    Оператор).
                  </p>
                  <p className="mb-4">
                ...
                <div className="">
                  ...
                  <p className="mb-4">
                    ...
                    данных; <br />– организовывать обработку персональных данных
                    ...
                    такого запроса; <br />– публиковать или иным образом
                    ...
                    <br />– исполнять иные обязанности, предусмотренные Законом
                ...
                <div className="">
                  ...
                  <p className="mb-4">5.1. Фамилия, имя, отчество.</p>
                  <p className="mb-4">5.2. Электронный адрес.</p>
                  <p className="mb-4">5.3. Номера телефонов.</p>
                  <p className="mb-4">5.4. Почтовый адрес.</p>
                  <p className="mb-4">
                  ...
                  <p className="mb-4">
                    5.9.1 Согласие на обработку персональных данных, разрешенных
                  ...
                  <p className="mb-4">
                    5.9.4 Согласие на обработку персональных данных, разрешенных
                ...
                <div className="">
                  <p className="mb-4">7. Цели обработки персональных данных</p>
                  <p className="mb-4">
                ...
                <div className="">
                  ...
                  <p className="mb-4">
                    ...
                    данных». с пометкой «Актуализация персональных данных».
                  </p>
                  <p className="mb-4">
                ...
                <div className="">
                  ...
                  <p className="mb-4">
                    12.1. Оператор не использует Трансграничную передачу данных
                ...
                <div className="">
                  <p className="mb-4">14. Заключительные положения</p>
                  <p className="mb-4">
                  ...
                  <p className="mb-4">
                    ...
                    <a
                      href="https://loyalgift.ru/policy"
                      className="text-blue-500 underline"
                    >
                      https://loyalgift.ru/policy
                    </a>
                    .
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center gap-6 justify-between">
              ...
              <button
                onClick={() => {
                  isPolic ? setPolicModal(false) : setisColor(true);
                }}
                className={isColor ? " opacity-40" : "  opacity-100"}
              >
                Принять соглашение
              </button>
            </div>
