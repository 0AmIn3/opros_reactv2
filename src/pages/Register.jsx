        ...
        questions: [
          {
            ...
            DefAnswers: [
              {
                title:
                  "Могу ли я остановить принятие любого решения, если оцениваю его небезопасным для себя?12",
                succ: false,
                answers: [
                  {
                    title:
              ...
              },
              {
                ...
                answers: [
                  ...
                  {
                    title:
                      "У меня нет эмоциональной связи с миссией нашей организации",
                    ansucc: false,
                  },
                ],
              },
              ...
              {
                title:
                  "Я могу влиять на любого коллегу и любой может влиять на меня?",
                succ: false,
                answers: [
                  {
                    title:
          ...
          },
          {
            ...
            DefAnswers: [
              {
                title:
                  "Могу ли я остановить принятие любого решения, если оцениваю его небезопасным для себя?11",
                succ: false,
                answers: [
                  {
                    title: "0",
          ...
          },
          {
            ...
            DefAnswers: [
              {
                title:
                  "Могу ли я остановить принятие любого решения, если оцениваю его небезопасным для себя?1dew",
                succ: false,
                answers: [
                  {
                    title: "0",
